      ...
      <div className="mentor-profile-page">
        ...
        <section className="mentor-profile-hero">
          ...
          >
            ...
            <small>
              {atCapacity
                ? "This mentor is not accepting new requests right now."
                : "This mentor is currently accepting mentorship requests."}
            </small>
          </div>
        </section>
              ...
              <div className="mentor-profile-detail-row">
                ...
                <div>
                  ...
                  <span>
                    ...
                    {maximumActiveMentees} active mentee spaces currently used
                  </span>
                </div>
              </div>
            </div>
